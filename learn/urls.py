...
urlpatterns = [
    ...
    path('abbt',learn.views.aboutt,name = 'abbt'),
    path('adblg',learn.views.addblog,name ='adblg'),
    path('vwblg',learn.views.viewblog,name='vwblg'),
    path('nws',learn.views.newss,name='nws'),
    path('cnt',learn.views.contactt,name='cnt'),
    path('crs',learn.views.coursess,name='crs'),
    path('std',learn.views.studdent,name='std'),
    path('tchr',learn.views.teacherr,name='tchr'),
    path('admn',learn.views.adminn,name='admn'),
    path('lgn',learn.views.loginn,name='lgn'),
    ...
    path('del_msg_teacher', learn.views.del_msg_teacher, name='del_msg_teacher'),
